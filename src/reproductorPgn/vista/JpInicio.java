...
/**
 * Esta clase representa el panel de inicio de la interfaz de usuario.
 * Permite al usuario seleccionar un archivo y reproducir una partida.
 */
public class JpInicio extends javax.swing.JPanel {
    ...
    /**
     * Constructor de la clase JpInicio. Inicializa los componentes y configura
     * el fondo y la apariencia del panel de menú.
     * @param control, instancia del controlador para recibir y enviar datos del modelo.
     */
    public JpInicio(Control control) {
        this.control = control;
        this.fondo = new ImageIcon(getClass().getResource("/recursos/imagenes/fondo/fondo.png"));
        initComponents();
    ...
    /**
     * Dibuja el fondo del panel de inicio.
     * @param g el contexto grafico el cual es usado para pintar el fondo.
     */
    ...
    /**
     * Crea un file chooser para que el usuario pueda seleccionar un archivo.
     * @return el archivo seleccionado por el usuario, null si el usuario no selecciono ningun archivo.
     */
