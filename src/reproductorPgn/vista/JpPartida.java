...
import reproductorPgn.modelo.Piezas;

/**
 * Esta clase representa el panel en el que se carga y reproduce la partida.
 * @author Cesar Acosta
 */
public class JpPartida extends javax.swing.JPanel {
    ...
    /**
     * Constructor de la clase JpPartida, incializa los atributos y carga un HashMap con las posiciones de las 
    ...
    public void actualizarInformacion(String informacion){
        ...
        if(resultado == JOptionPane.YES_OPTION){
            ...
            control.cambiarPanel("inicio");
            control.reiniciar();
            control.setArchivo(null);
        }
    }
